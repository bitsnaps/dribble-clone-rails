...
class ShotsControllerTest < ActionController::TestCase
  ...
  test "should create shot" do
    assert_difference('Shot.count') do
      post :create, shot: { description: @shot.description, title: @shot.title, user_id: @shot.user_id }
    end
  ...
  test "should update shot" do
    patch :update, id: @shot, shot: { description: @shot.description, title: @shot.title, user_id: @shot.user_id }
    assert_redirected_to shot_path(assigns(:shot))
  end
